...
export default function RegisterPage() {
	...
	return (
		<div className="flex min-h-screen">
			{/* Left brand panel */}
			<AuthBrandPanel
				germanPhrase="Los geht's!"
				phraseTranslation="Ayo mulai!"
				heading="Mulai perjalananmu"
				subheading="Daftar gratis dan belajar bahasa Jerman hari ini."
				items={[
			...
			<div className="flex flex-1 flex-col items-center justify-center bg-background px-8 py-12">
				<div className="w-full max-w-sm space-y-8">
					<div>
						<h1 className="font-display text-3xl font-semibold text-foreground">Buat akun</h1>
